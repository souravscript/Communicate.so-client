...
interface SideBarDataIconProps {
  className?: string;
}

const SideBarDataIcon: React.FC<SideBarDataIconProps> = ({ className }) => {
  return (
    <svg 
      width="20" 
      height="20" 
...
export default SideBarDataIcon;
